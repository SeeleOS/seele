...
use root::{
    ...
    PROC_SYS_KERNEL_RANDOM_UUID_INODE, PROC_SYS_KERNEL_TAINTED_INODE, PROC_UPTIME_INODE,
    ...
    proc_random_uuid_bytes, proc_root_entries, proc_stat_bytes, proc_tainted_bytes,
    proc_uptime_bytes,
};

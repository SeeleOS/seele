...
use root::{
    PROC_CMDLINE_INODE, PROC_DEVICES_INODE, PROC_FILESYSTEMS_INODE, PROC_LOADAVG_INODE,
    PROC_MEMINFO_INODE, PROC_MOUNTS_INODE, PROC_PRESSURE_CPU_INODE, PROC_PRESSURE_INODE,
    PROC_PRESSURE_IO_INODE, PROC_PRESSURE_MEMORY_INODE, PROC_ROOT_INODE, PROC_SELF_INODE,
    PROC_STAT_INODE, PROC_SYS_FS_FILE_MAX_INODE, PROC_SYS_FS_INODE, PROC_SYS_FS_INOTIFY_INODE,
    ...
    PROC_VERSION_INODE, proc_boot_id_bytes, proc_cap_last_cap_bytes, proc_devices_bytes,

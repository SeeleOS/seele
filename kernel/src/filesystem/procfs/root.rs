...
pub(super) const PROC_SYS_FS_PIPE_MAX_SIZE_INODE: u64 = 0x302e;
pub(super) const PROC_SYS_FS_PIPE_USER_PAGES_SOFT_INODE: u64 = 0x302f;
...
pub(super) const PROC_SYS_KERNEL_KEYS_GC_DELAY_INODE: u64 = 0x3035;
pub(super) const PROC_SYS_USER_INODE: u64 = 0x3036;
pub(super) const PROC_SYS_USER_MAX_USER_NAMESPACES_INODE: u64 = 0x3037;
...
fn sorted_mounts() -> Vec<ProcMountSnapshot> {
    ...
    let mut mounts = VirtualFS
        .lock()
        .visible_mount_snapshots_with_propagation(namespace_snapshot.as_deref())
        .into_iter()
        .map(

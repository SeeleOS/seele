use crate::{
    drm::{
        ...
        client::{
            ...
            DRM_CAP_DUMB_PREFERRED_DEPTH, DRM_CAP_PAGE_FLIP_TARGET, DRM_CAP_PRIME,
            DRM_CAP_SYNCOBJ, DRM_CAP_SYNCOBJ_TIMELINE, DRM_CAP_TIMESTAMP_MONOTONIC,
            DRM_CAP_VBLANK_HIGH_CRTC, DRM_CLIENT_CAP_ASPECT_RATIO, DRM_CLIENT_CAP_ATOMIC,
            DRM_CLIENT_CAP_CURSOR_PLANE_HOTSPOT, DRM_CLIENT_CAP_PLANE_COLOR_PIPELINE,
            DRM_CLIENT_CAP_STEREO_3D, DRM_CLIENT_CAP_UNIVERSAL_PLANES,
            DRM_CLIENT_CAP_WRITEBACK_CONNECTORS, DRM_EVENT_VBLANK, DRM_PRIME_CAP_EXPORT,
            DRM_PRIME_CAP_IMPORT, DRM_VBLANK_EVENT, DRM_VBLANK_FLAGS_MASK, DRM_VBLANK_FLIP,
            DRM_VBLANK_SIGNAL, DRM_VBLANK_TYPES_MASK,
        },
    },
    memory::user_safe,
...
pub(super) fn handle_set_client_cap(
    ...
    match (cap.capability, cap.value) {
        ...
        | (DRM_CLIENT_CAP_CURSOR_PLANE_HOTSPOT, 0)
        | (DRM_CLIENT_CAP_PLANE_COLOR_PIPELINE, 0) => Ok(0),
        (DRM_CLIENT_CAP_ATOMIC, _)
        | (DRM_CLIENT_CAP_WRITEBACK_CONNECTORS, _)
        | (DRM_CLIENT_CAP_CURSOR_PLANE_HOTSPOT, _)
        | (DRM_CLIENT_CAP_PLANE_COLOR_PIPELINE, _) => Err(ObjectError::Unimplemented),

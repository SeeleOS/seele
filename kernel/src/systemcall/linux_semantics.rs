...
pub const LINUX_SYSCALL_SEMANTICS_COVERAGE: &[LinuxSyscallCoverage] = syscall_coverage!(
    unit {
        ...
        PerfEventOpen => "optional_fd_provider_syscalls_return_linux_feature_unavailable_errors",
        FanotifyInit => "optional_fd_provider_syscalls_return_linux_feature_unavailable_errors",
        Userfaultfd => "optional_fd_provider_syscalls_return_linux_feature_unavailable_errors",
        IoUringSetup => "optional_fd_provider_syscalls_return_linux_feature_unavailable_errors",
        MemfdSecret => "optional_fd_provider_syscalls_return_linux_feature_unavailable_errors",
        Acct => "process_accounting_syscalls_follow_linux_rules",
        ...
        Adjtimex => "clock_and_affinity_syscalls_follow_linux_pointer_rules",
        ClockAdjtime => "clock_and_affinity_syscalls_follow_linux_pointer_rules",
        ...
        OpenAt2 => "filesystem_fd_state_syscalls_follow_linux_rules",
        Open => "filesystem_fd_state_syscalls_follow_linux_rules",
        Creat => "filesystem_fd_state_syscalls_follow_linux_rules",
        Truncate => "filesystem_file_object_syscalls_follow_linux_rules",
        ...
        Preadv => "filesystem_io_syscalls_follow_linux_rules",
        Pwritev => "filesystem_io_syscalls_follow_linux_rules",
        Preadv2 => "filesystem_io_syscalls_follow_linux_rules",
        Pwritev2 => "filesystem_io_syscalls_follow_linux_rules",
        ...
        FileGetattr => "filesystem_file_attr_syscalls_follow_linux_rules",
        FileSetattr => "filesystem_file_attr_syscalls_follow_linux_rules",
        ...
        Mlockall => "memory_mapping_syscalls_follow_linux_rules",
        Munlockall => "memory_mapping_syscalls_follow_linux_rules",
        ...
        Cachestat => "cachestat_syscall_follows_linux_cache_query_rules",
        Tee => "pipe_and_dup_syscalls_follow_linux_fd_rules",
        Vmsplice => "pipe_and_dup_syscalls_follow_linux_fd_rules",
        SyncFileRange => "filesystem_file_object_syscalls_follow_linux_rules",
        MqOpen => "posix_message_queue_syscalls_follow_linux_rules",
        MqUnlink => "posix_message_queue_syscalls_follow_linux_rules",
        MqTimedsend => "posix_message_queue_syscalls_follow_linux_rules",
        MqTimedreceive => "posix_message_queue_syscalls_follow_linux_rules",
        MqNotify => "posix_message_queue_syscalls_follow_linux_rules",
        MqGetsetattr => "posix_message_queue_syscalls_follow_linux_rules",
        ...
        OpenTreeAttr => "mount_api_syscalls_follow_linux_rules",

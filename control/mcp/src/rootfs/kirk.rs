...
namespace_pattern="pidns.*|mqns_.*|netns_.*|shmnstest.*|shmem_2nstest.*|shm_comm|mesgq_nstest.*|msg_comm|sem_nstest.*|semtest_2ns.*|sem_comm|utsname.*|mountns.*|userns.*|timens.*|clock_nanosleep03|clock_gettime03|sysinfo03|timerfd04|ioctl_ns.*|ioctl_pidfd0[2-5]|unshare01_sh"
